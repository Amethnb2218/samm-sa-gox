      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "10px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
            <div style={{ width: "28px", height: "28px", backgroundColor: "var(--color-baobab)", borderRadius: "var(--radius-sm)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "9px", color: "var(--color-text-muted)", lineHeight: 1, marginTop: "2px", fontFamily: "var(--font-mono)", letterSpacing: "0.04em" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <div style={{ display: "flex", borderRadius: "var(--radius-sm)", overflow: "hidden", border: "1px solid var(--color-border)" }}>
            <button
              ...
              style={{
                ...
                border: "none",
                cursor: "pointer",
                backgroundColor: lang === "fr" ? "var(--color-baobab)" : "transparent",
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                backgroundColor: lang === "wol" ? "var(--color-baobab)" : "transparent",
          ...
          <span className="label-caps" style={{ fontSize: "9px", color: "var(--color-terre)" }}>
            ANSD 20 ans
          </span>
        </div>
      </div>
