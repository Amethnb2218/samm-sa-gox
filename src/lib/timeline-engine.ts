...
const NATIONAL_TIMELINE_DATA: Record<string, TimelinePoint[]> = {
  population: [
    { year: 2006, value: 11.4, source: "ANSD — RGPH-3 2002 (projection)" },
    { year: 2008, value: 12.1, source: "ANSD — projection intercensitaire" },
    { year: 2010, value: 12.9, source: "ANSD — projection intercensitaire" },
    { year: 2013, value: 14.1, source: "ANSD — RGPHAE 2013" },
    { year: 2016, value: 15.4, source: "ANSD — projection RGPHAE" },
    { year: 2019, value: 16.7, source: "ANSD — projection intercensitaire" },
    { year: 2023, value: 18.3, source: "ANSD — RGPH-5 2023" },
    { year: 2026, value: 19.4, source: "ANSD — projection RGPH-5" },
  ],
  scolarisation: [
    { year: 2006, value: 72.3, source: "ANSD — Enquête ménages 2006" },
    { year: 2010, value: 78.1, source: "ANSD — EDS 2010" },
    { year: 2013, value: 81.5, source: "ANSD — RGPHAE 2013" },
    { year: 2016, value: 83.2, source: "ANSD — EDS-Continue 2016" },
    { year: 2019, value: 85.7, source: "ANSD — EDS-Continue 2019" },
    { year: 2023, value: 88.4, source: "ANSD — RGPH-5 2023" },
  ],
  urbanisation: [
    { year: 2006, value: 40.5, source: "ANSD — projection RGPH-3" },
    { year: 2010, value: 42.3, source: "ANSD — estimation" },
    { year: 2013, value: 44.2, source: "ANSD — RGPHAE 2013" },
    { year: 2016, value: 45.8, source: "ANSD — projection RGPHAE" },
    { year: 2019, value: 47.1, source: "ANSD — estimation" },
    { year: 2023, value: 48.6, source: "ANSD — RGPH-5 2023" },
    { year: 2026, value: 49.2, source: "ANSD — projection RGPH-5" },
  ],
  acces_eau: [
    { year: 2006, value: 64, source: "ANSD — Enquête ménages" },
    { year: 2010, value: 69, source: "ANSD — EDS 2010" },
    { year: 2013, value: 73, source: "ANSD — RGPHAE 2013" },
    { year: 2016, value: 77, source: "ANSD — EDS-Continue 2016" },
    { year: 2019, value: 80, source: "ANSD — EDS-Continue 2019" },
    { year: 2023, value: 84, source: "ANSD — RGPH-5 2023" },
  ],
  acces_electricite: [
    { year: 2006, value: 42, source: "ANSD + Senelec" },
    { year: 2010, value: 52, source: "ANSD — EDS 2010" },
    { year: 2013, value: 58, source: "ANSD — RGPHAE 2013" },
    { year: 2016, value: 64, source: "ANSD — EDS-Continue 2016" },
    { year: 2019, value: 71, source: "ANSD — EDS-Continue 2019" },
    { year: 2023, value: 78, source: "ANSD — RGPH-5 2023" },
    { year: 2026, value: 83, source: "ANSD + Senelec 2026 (estimation)" },
  ],
  pauvrete: [
    { year: 2006, value: 50.8, source: "ANSD — ESPS 2005-06" },
    { year: 2011, value: 46.7, source: "ANSD — ESPS-II 2011" },
    { year: 2019, value: 37.8, source: "ANSD — EHCVM 2018-19" },
    { year: 2024, value: 36.2, source: "ANSD — EHCVM 2024 (estimation)" },
  ],
};
